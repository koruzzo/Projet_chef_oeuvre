    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <select name="role" id="role" class="form-select mt-1 block w-full" required>
                <option value="apifan">ApiFan</option>
        ...
        <div class="mt-4">
            ...
            <x-text-input id="ville" class="block mt-1 w-full" type="text" name="ville" :value="old('ville')" required autofocus autocomplete="address-level2" />
