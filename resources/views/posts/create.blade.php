<x-app-layout>
    ...
    <form action="{{ route('posts.store') }}" method="post" enctype="multipart/form-data" class="p-4 mx-auto mt-5 w-full md:w-3/4 lg:w-1/2 xl:w-2/3 flex justify-center flex-col formu-style font-exo-2"> 
        @csrf
        ...
        <div class="dispo-image">
            <label for="picture" class="p-2 md:p-4 label-image dispo-image">Votre image de post :
